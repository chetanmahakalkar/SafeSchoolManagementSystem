...
import "./MyProfilePrincipal.css";

import Schedule from "../Schedule/DashboardSchedule";

function MyProfilePrincipal() {
  return (
    <div>
      <Navbar color="info">
      ...
      <div className="ProfileBody">
        <Row className="border">
          ...
          <Col md={8}>
            ...
            <div class="dropdown ml-2 mr-2 mt-2 md-2">
              <button class="dropbtn ">Manage Principal Data</button>
              <div class="dropdown-content">
                {/* to register new Principal data */}
                <a href="#">Add Principal</a>
                {/* to update principal data */}
                <a href="#">Update Principal</a>
                {/* to delete Principal data */}
                <a href="#">Delete Principal</a>
                {/* to direct to menu to search Principal data: by name /id/classid */}
                <a href="#">Search Principal</a>
              </div>
            </div>
...
export default MyProfilePrincipal;
